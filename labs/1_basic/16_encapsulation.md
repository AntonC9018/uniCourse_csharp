---
slug: ru/labs/basic/encapsulation
---
<!-- course-site-backlink:start -->
[Этот урок на сайте](https://AntonC9018.github.io/uniCourse_csharp/ru/labs/basic/encapsulation/)
...
### 5. Класс связывает *состояние* и *операции над ним*
...
### 8. Явная граница между *интерфейсом* и *реализацией*
...
### 9. Класс — это стабильный контракт, который можно развивать
