---
slug: ru/labs/design/dependenices
---
<!-- course-site-backlink:start -->
[Этот урок на сайте](https://AntonC9018.github.io/uniCourse_csharp/ru/labs/design/dependenices/)
<!-- course-site-backlink:end -->
# Зависимости абстракций
...
- Принципы inversion of control и dependency injection.
- Принцип dependency inversion.
- Использование DI (IoC) контейнера.
...
2. (дополнительно) Обработать их определенным образом 
...
При этом необходимо соблюдать принцип Single Responsibility.
...
Дополнительно (обработка данных):
- Сделайте 2 обычные статические функции для преобразования данных на основе `IEnumerable<>`.
